...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    url_point = "https://www.reliancedigital.in/search?q=:relevance:availability:Exclude%20out%20of%20Stock&page="
    api_url = url_point + "{}"
    ...
    def parse(self, response):        
        ...
        for j in scrapy_selector.css("li.grid"):
            url = j.css("a::attr(href)").get() or "NAN"
            yield LinkExtracters(url=url, website="www.reliancedigital.in")
        if 1==1 and self.i!=238:
            self.i = self.i+1
