...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        pid = response.url
        price_mrp = scrapy_selector.css("span.priceBlockStrikePriceString::text").get() 
        price = scrapy_selector.css("span.priceBlockBuyingPriceString::text").get() 
        price_2 = scrapy_selector.css("#regularprice_savings > td.priceBlockSavingsString::text").get() 
