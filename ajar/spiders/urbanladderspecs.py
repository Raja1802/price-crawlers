...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        mycol = mydb.Links
        mydoc = mycol.find({"store_id": 33231})
    ...
    def parse(self, response):
        ...
        for i in scrapy_selector.css("#product-properties > li"):
            pid = response.url
            specKey = i.css("span.property_key::text").get() 
            specValue = i.css("span.property_val > span::text").get() or i.css("span.property_val::text").get()
