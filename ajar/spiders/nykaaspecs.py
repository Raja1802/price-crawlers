...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in scrapy_selector.css("div.pdp-description-tab-item") or scrapy_selector.css("div.FqsW"):
            pid = response.url
            specKey = "Specification"
            specValue = i.css("div > p::text").get() or i.css("div > ul > li::text").get() 
