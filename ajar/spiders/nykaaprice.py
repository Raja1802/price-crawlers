...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    #     mycol = mydb.Links
    #     mydoc = mycol.find({"store_id": 33240})
    ...
    def parse(self, response):
        ...
        pid = response.url
        price_mrp = scrapy_selector.css("span.mrp-price::text").getall() 
        price = scrapy_selector.css("span.post-card__content-price-offer::text").getall()
        price_2 = scrapy_selector.css('span.post-card__offers-offer::text').getall() 
