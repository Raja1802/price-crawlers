...
class QuotesInfiniteScrollSpider(CrawlSpider):
    ...
    start_urls = ["https://shop.nordstrom.com/"]
    ...
    def parse_result(self, response):
        ...
        product_mrp = (
            scrapy_selector.css(
                "#product-page-price-lockup > span._2VQ4q > span._2bkjG::text"
            ).getall()
            # or response.css(
        ...
        product_description = (
            scrapy_selector.css("#product-page-selling-statement::text").getall()
            # or scrapy_selector.css("div._3la3Fn._1zZOAc > p::text").getall()
            # or scrapy_selector.css("div._3la3Fn::text").getall()
        )
        product_name = (
            scrapy_selector.css(
                "#product-page-product-title-lockup > div > h1::text"
            ).getall()
        ...
        product_by_url = "shop.nordstrom.com"
        product_by_name = "nordstrom"
        product_rating = (
            scrapy_selector.css(
                "#reviews > section > div > header > div > div > div > div::text"
            ).getall()
            or "NULL"
        )
        product_image = (
            ...
            # ).get()
            scrapy_selector.css(
                "#product-page-main-gallery-image > img::attr(srcset)"
            ).get()
        ...
        product_price = (
            scrapy_selector.css("#current-price-string::text").get()
            # or response.css(
        ...
        product_about = (
            scrapy_selector.css("div._3RNkd > div > ul > li> span::text").getall()
            # or scrapy_selector.css("div._3WHvuP > ul > li._2-riNZ::text").getall()
        )
        product_keywords = scrapy_selector.css(
            "#selling-essentials > div > div._2_Avt._9UURo > div > span::text"
        ).getall()
        product_catlog = (
            scrapy_selector.css(" div.hZRDN._3XEVq > section > a > span::text").getall()
        ...
        product_price_2 = (
            ...
            # ).getall()
            scrapy_selector.css(
                "#product-page-price-lockup > span> span._1q2Ab::text"
            ).getall()
        )
