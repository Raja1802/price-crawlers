...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        pid = response.url
        price_mrp = scrapy_selector.css("div.strikeprice > div::text").get()
        price = scrapy_selector.css("div.price::text").get()
        price_2 = scrapy_selector.css("div.price::text").get()
